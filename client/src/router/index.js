...
router.beforeEach((to, from, next) => {
  ...
  if (!userData && to.path !== '/login-page' && to.path !== '/register-page' && to.path !== '/fgpassword-page' && to.path !== '/reset-password-page' && to.path !== '/landing-page' && to.path !== '/book-read-page' && to.path !== '/help-page') {

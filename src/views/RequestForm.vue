                ...
                <div class="FormContainer">
                    <div class="Form-banner-container">
                        <div class="loginForm">
                            ...
                            <p class="Form-presentation"> <br> Didn't find the book you were looking for ? <i class="fa fa-bold"
                                    aria-hidden="true">No worries !</i> <br><br> Please fill in the following form, and our team will do its best to quickly add your awaited book to our library !
                                <br><br></p>
                            <form action="#" method="post">
                                <p class="Form-question">Please enter the <i class="fa fa-bold"
